...
?>
            ...
            <aside class="right-side">
              ...
              <form action="edit_len2.php" name="frmAdd" method="post"> 

              <?php
                 $len = $_GET["len"];
                include "../server.php";
                $sql = "SELECT * FROM len WHERE id_len = '$len'";
                $query = mysqli_query($objCon,$sql);
                while($result=mysqli_fetch_array($query,MYSQLI_ASSOC)){
                $id_len = $result["id_len"];
                $name_len = $result["name_len"];
                $price_len = $result["price_len"];
                }
              ?>    
                              <form role="form">
                                    <div class="box-body">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6 ">
                                            ...
                                            <input type="text" class="form-control" name="name" value="<?php echo $name_len;?>" >
                                        </div>
                                        <div class="form-group col-md-6 ">
                                            <label for="pass">ราคาเลนส์</label>
                                            <input type="text" class="form-control" name="price" value="<?php echo $price_len;?>" >
                                        </div>
                                    ...
                                    <input type="hidden" name="id" value="<?php echo $id_len;?>">
                                </form>
                            </div><!-- /.box -->
