...
?>
            ...
            <aside class="right-side">
              ...
              <form action="edit_frame2.php" name="frmAdd" method="post"> 

              <?php
                 $frame = $_GET["frame"];
                include "../server.php";
                $sql = "SELECT * FROM product WHERE id_pro = '$frame'";
                              ...
                              <form role="form">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6 ">
                                            <label for="user">ชื่อกรอบแว่น</label>
                                            <input type="text" class="form-control" name="name" value="<?php echo $name_pro;?>" >
                                        </div>
                                        <div class="form-group col-md-6 ">
                                            <label for="pass">ราคาเลนส์</label>
                                            <input type="text" class="form-control" name="price" value="<?php echo $price_pro;?>" >
                                        </div>
