...
?>
            ...
            <aside class="right-side">
              ...
              <div class="col-md-12">
                <label>&nbsp;&nbsp;แก้ไขข้อมูลการตัดเลนส์</label>
              <div class="modal-content" >
              <div class="box box-primary">
              <div class="box-header">
              <meta http-equiv=Content-Type content="text/html; charset=windows-874">
              <form action="edit_history_cus2.php" name="form1" method="post"> 
                <?php
                 $idtud = $_GET["idtud"];
                 $idcus = $_GET["idcus"];
                 $_SESSION["idtud9999"] = $_GET["idtud"];
                 $_SESSION["idcus9999"] = $_GET["idcus"];
                include "../server.php";
                $sql = "SELECT * FROM customer,tudlen WHERE customer.id_cus = tudlen.id_cus && tudlen.id_tud='$idtud'";
                                ...
                                <form role="form">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5 ">
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="ชื่อ - สกุล" value="<?php echo $result["name_cus"]; ?>" readonly="1">
                                        </div> 
                                        <div class="form-group col-md-3 ">
                                            <label for="age">อายุ</label>
                                            <input type="text" class="form-control" name="age" placeholder="อายุ" value="<?php echo $result["age"]; ?>" readonly="1">
                                        </div>
                                        <div class="form-group col-md-3 ">                                
                                            <label for="day">วันที่ตัดเลนส์</label>
                                            <input type="date" class="form-control" name="day" value="<?php echo $result["date_tud"]; ?>">
                                        </div>
                                        <div class="form-group col-md-5 "> 
                                            <label for="company">ชื่อบริษัท / ร้านค้า</label>
                                            <input type="text" class="form-control" name="company" placeholder="ชื่อบริษัท หรือ ร้านค้า" value="<?php echo $result["company"]; ?>" readonly="1">
                                        </div>
                                       <div class="form-group col-md-3">
                                            <label for="tel">เบอร์โทรศัพท์</label>
                                            <input type="text" class="form-control" name="tel" placeholder="xxx-xxxxxxx" value="<?php echo $result["tel"]; ?>" readonly="1">
                                        </div>
                                        
                                        <div class="form-group col-md-11"> 
                                            <label for="address">ที่อยู่</label>
                                            <textarea type="text" class="form-control" name="address" rows="3" readonly="1"><?php echo $result["address"]; ?></textarea>
                                        </div>
                                        <div class="form-group col-md-5 "> 
                                            <label for="right">ค่าสายตาขวา (R)</label>
                                            <input type="text" class="form-control" name="right" placeholder="สั้น x เอียง x องศา" value="<?php echo $result["r"]; ?>">
                                        </div>
                                        <div class="form-group col-md-3 "> 
                                            <label for="pdr">PD</label>
                                            <input type="text" class="form-control" name="pdr" placeholder="xx" value="<?php echo $result["pdr"]; ?>">
                                        </div>
                                        <div class="form-group col-md-5 "> 
                                            <label for="left">ค่าสายตาซ้าย (L)</label>
                                            <input type="text" class="form-control" name="left" placeholder="สั้น x เอียง x องศา" value="<?php echo $result["l"]; ?>">
                                        </div>
                                        <div class="form-group col-md-3 "> 
                                            <label for="pdl">PD</label>
                                            <input type="text" class="form-control" name="pdl" placeholder="xx" value="<?php echo $result["pdl"]; ?>">
                                        </div>
                                        <div class="form-group col-md-5">
                                        <label for="exampleInputId_title1">กรอบที่ตัด</label>
                                                ...
                                                <option value="0">เลือกประเภทกรอบแว่น</option>
                                                   <?php
                                                    ...
                                                    if($row9[name_pro]==$result["id_pro"]){
                                                    echo "<option value='$row9[name_pro]' selected>$row9[name_pro]</option>";
                                                    $hsttime .= ",".$row9["price_pro"];
                                                    }elseif($row9[name_pro]!=$result["id_pro"] ){
                                                    echo "<option value='$row9[name_pro]' >$row9[name_pro]</option>";
                                                    $hsttime .= ",".$row9["price_pro"];
                                                    }
                                                    ?>
                                                </select>
                                         ...
                                         <div class="form-group col-md-3 "> 
                                            ...
                                            <input type="text" class="form-control" name="c_date" id="c_date" value="<?php echo $result["price_pro"]; ?>">
                                        </div>
                                        ...
                                        <label for="exampleInputId_title1">เลนส์ที่ตัด</label>
                                                ...
                                                <?php
                                                    include "../server.php";
                                                    $sql9="select * from len ";
                                                    $result9=mysqli_query($objCon,$sql9);
                                                    while($row9=mysqli_fetch_array($result9,MYSQLI_ASSOC))
                                                    if($row9[name_len]==$result["id_len"]){
                                                    echo "<option value='$row9[name_len]' selected>$row9[name_len]</option>";
                                                    $hcdate .= ",".$row9["price_len"];
                                                    }elseif($row9[name_len]!=$result["id_len"] ){
                                                    echo "<option value='$row9[name_len]' >$row9[name_len]</option>";
                                                    $hcdate .= ",".$row9["price_len"];
                                                    }
                                                    ?>
                                         ...
                                         <div class="form-group col-md-3 "> 
                                            ...
                                            <input type="text" class="form-control" name="st_time" id="st_time" value="<?php echo $result["price_len"]; ?>">
                                        </div>
                                         <div class="form-group col-md-3 "> 
                                            <label for="name">ราคารวม <font color="red">(เปลี่ยนได้ตามจริง)</font></label>
                                            <input type="text" class="form-control" name="output" id="output" value="<?php echo $result["total_price"]; ?>">
                                        </div>
                                        
                                        <div class="form-group col-md-11"> 
                                            <label for="comment">หมายเหตุ</label>
                                            <textarea type="text" class="form-control" name="comment" rows="3"><?php echo $result["comment_tud"]; ?></textarea>
                                        </div>
