...
?>
            ...
            <aside class="right-side">
              ...
              <div class="col-md-12">
                <label>&nbsp;&nbsp;เพิ่มข้อมูลกรอบแว่น</label>
              
              <div class="modal-content" >
              <div class="box box-primary">
              <div class="box-header">
              <meta http-equiv=Content-Type content="text/html; charset=windows-874">
              <form action="insert_frame2.php" name="frmAdd" method="post"> 
                              ...
                              <form role="form">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6 ">
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="ชื่อกรอบแว่น" autocomplete="off" required>
                                        </div>
                                        <div class="form-group col-md-6 ">
