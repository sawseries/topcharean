...
?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i>เลื่อนนัดผู้ป่วย</a></li>
                    </ol>
                </section>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <label>&nbsp;&nbsp;เลื่อนนัดผู้ป่วย</label>
                            <div class="box">
                            <br>

                            <th width="150" colspan="2" ><a target=_blank
                                href="tableapp_d.php"><button type="button" class="btn btn-primary">ตารางทันตแพทย์</button></a></th>
                                </tr>
                                ...
                                <?php
              	include "../../../server.php";
          	    $sql = "SELECT * FROM appointment,members,status where members.user_name=appointment.user_name 
                        && status.status_id=appointment.status_id && app_date >= now() && status.status_id != '4'  && status.status_id != '3' 
    ...
    data-target="#myModal<?php echo $result['app_id'];?>">ขอเลื่อนนัด</button>
            </td>
    <?php 
        include ("../modal_data/postpone_modal.php");
    ?>
