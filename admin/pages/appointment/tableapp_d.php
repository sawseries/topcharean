                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li ><a href="../../../admin/pages/check/check_dentist.php"><i class="fa fa-angle-double-right"></i>ตรวจสอบตารางทันตแพทย์</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ตารางทันตแพทย์</li>
                    </ol>
                </section>
