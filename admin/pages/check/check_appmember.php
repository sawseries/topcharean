...
?>
            ...
            <aside class="right-side">
                ...
                <h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ประวัติการนัดหมาย</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <th><center>รายละเอียดการนัดหมาย</th>
                                <th><center><center></th>         
                                </thead>
                                ...
                                <?php
                include "../../../server.php";
                  $sql = "SELECT * FROM appointment where user_name = '$abc' ";
                  $i = 1;
    ...
    data-target="#myModal<?php echo $result['app_id'];?>"> เปิดดู</button>
            </td>
    <?php 
        include ("../modal_data/app_modal.php");
    ?>
                </tr> 
            <?php
                $i++;
