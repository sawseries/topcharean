...
?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active ">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active" ><a href="#"><i class="fa fa-angle-double-right"></i>ตำแหน่ง</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                href="insert_position.php"><button type="button" class="btn btn-primary">เพิ่มข้อมูล</button></a></center></th>
                                </tr>           
                                </thead>
            <?php
              	include "../../../server.php";
            ...
            <td align="center"><a href="edit_position.php?user11=<?php echo $result["position_id"];?>"><button type="button" class="btn btn-warning">แก้ไข</button></a></td>
            <td align="center"><a href="delete_position.php?user11=<?php echo $result["position_id"];?>" 
