...
?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active ">
                            ...
                            <ul class="treeview-menu">
                                <li ><a href="employees.php"><i class="fa fa-angle-double-right"></i>ผู้ใช้</a></li>
                                <li class="active" ><a href="position.php"><i class="fa fa-angle-double-right"></i>ตำแหน่ง</a></li>
            ...
            <aside class="right-side">
              ...
              <form action="edit_position2.php" name="frmAdd" method="post">
              <div class="box-body"
              <?php
                $user999 = $_GET["user11"];
                include "../../../server.php";
            	$sql = "SELECT * FROM position where position.position_id = '$user999' "; 
   	            $query = mysqli_query($objCon,$sql);
	            while($result=mysqli_fetch_array($query,MYSQLI_ASSOC)){
                $positionid123 = $result["position_id"];
                                ...
                                <form role="form">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="txtPositionId"
                                            value="<?php echo $positionid123;  ?>" readonly="2" >
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="position_name">ชตำแหน่ง</label>
                                            <input type="text" class="form-control" name="txtPositionName" 
                                            value="<?php echo $positionname123;  ?>" >
                                        </div>
                                        </div>
