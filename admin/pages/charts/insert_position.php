...
?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
              ...
              <form action="insert_position2.php" name="frmAdd" method="post"> 
              <?php
				include "../../../server.php";
   				$sql = "SELECT * FROM position order by position_id  asc";
   				$query = mysqli_query($objCon,$sql);
				while($result=mysqli_fetch_array($query,MYSQLI_ASSOC))
                { $aaa = $result["position_id"];}
	            $total=$aaa+1;
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group col-md-6 ">
                                            ...
                                            <input type="text" class="form-control" name="txtPositionId"  value = "<?php echo $total; ?>" readonly>
                                        </div> 
                                        <div class="form-group col-md-6 ">
                                            <label for="position_name">ตำแหน่ง</label>
                                            <input type="trxt" class="form-control" name="txtPositionName" placeholder=ตำแหน่ง required>
                                        </div>
                                        </div>
