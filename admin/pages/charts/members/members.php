        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                       ...
                       <!-- <li>
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="../members/members.php"><i class="fa fa-angle-double-right"></i>สมาชิก</a></li>
                            </ul>
                        </li>
                        <li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                href="insert_members.php"><button type="button" class="btn btn-primary">เพิ่มข้อมูล</button></a></center></th>
                                </tr>           
                                </thead>
            ...
            ?>       
                <tr>
                                ...
                                <td><?php echo $result["memb_address"];?></td>
                                <td><?php echo $result["memb_tel"];?></td>
                                <td><?php echo $result["memb_diseased"];?></td>
                                <td><?php echo $result["memb_drug_allergy"];?></td>
            <td align="center"><a href="edit_members.php?user11=<?php echo $result["user_name"];?>"><button type="button" class="btn btn-warning">แก้ไข</button></a></td>
            <td align="center"><a href="delete_members.php?user11=<?php echo $result["user_name"];?>" 
