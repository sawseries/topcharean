    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
              ...
              <form action="insert_members2.php" name="frmAdd" method="post"> 
              <div class="box-body"
                               ...
                               <div class="box-body">
                                    <div class="form-row">
                                        ...
                                        <td><select type="text" class="form-control" name="txtTitle">
                                        ...
                                        <div class="form-group col-md-5 ">
                                            ...
                                            <input type="text" class="form-control" name="txtName" placeholder=ชื่อ >
                                        </div>
                                        <div class="form-group col-md-5 ">
                                            <label for="memb_lastname">นามสกุล</label>
                                            <input type="text" class="form-control" name="txtLast" placeholder=นามสกุล>
                                        </div>
                                        <div class="form-group col-md-6 ">
                                            <label for="memb_age">อายุ</label>
                                            <input type="text" class="form-control" name="txtAge" placeholder=อายุ>
                                        </div>
                                        <div class="form-group col-md-6 ">
                                            <label for="memb_blood">กรุ๊ปเลือด</label>
                                            <td><select type="text" class="form-control" name="txtBlood">
			                                <option value="">เลือกกรุ๊ปเลือด</option>
                                        ...
                                        <div class="form-group col-md-6 ">
                                            ...
                                            { alert('กรุณากรอกเบอร์โทรศัพท์ของคุณ'); this.value='';}" placeholder=x-xxxx-xxxxx-xx-x
                                            onKeyUp="if(this.value*1!=this.value) this.value='' ;" minlength="13" maxlength="13">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="memb_birth">วัน/เดือน/ปีเกิด</label>
                                            <input type="date" class="form-control" name="txtBirth" placeholder=วัน/เดือน/ปี>
                                        </div>
                                        <div class="form-group col-md-12 ">
                                            <label for="memb_address">ที่อยู่</label>
                                            <textarea type="text" class="form-control" name="txtAdd" placeholder=ที่อยู่></textarea>
                                        </div>
                                        <div class="form-group col-md-6 ">
                                            <label for="memb_tel">เบอร์โทรศัพท์</label>
                                            <input type="text" class="form-control" name="txtTel" onKeyUp="if(isNaN(this.value))
                                            { alert('กรุณากรอกเบอร์โทรศัพท์ของคุณ'); this.value='';}"placeholder=xxx-xxx-xxxx
                                            onKeyUp="if(this.value*1!=this.value) this.value='' ;" minlength="10" maxlength="10">
                                        </div>
                                        <div class="form-group col-md-6 ">
                                            <label for="memb_diseased">โรคประจำตัว</label>
                                            <input type="text" class="form-control" name="txtDiseased" placeholder=โรค>
                                        </div>
                                        <div class="form-group col-md-12 ">
                                            <label for="memb_drug_allergy">แพ้ยา</label>
                                            <textarea type="text" class="form-control" name="txtDrugAllergy" placeholder=แพ้ยา></textarea>
                                        </div>
                                        </div>
