    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">แก้ไข</li>
              ...
              <form action="edit_dentist2.php" name="frmAdd" method="post"> 
              <div class="box-body"
              <?php
	            $user999 = $_GET["user11"];
	            include "../../../../server.php";
            	$sql = "SELECT * FROM dentist,login where login.user_name = dentist.user_name && dentist.user_name = '$user999'";
   	            $query = mysqli_query($objCon,$sql);
	            while($result=mysqli_fetch_array($query,MYSQLI_ASSOC)){
                $user123 = $result["user_name"];
                $pass123 = $result["password"];
	            $title123 = $result["title"];
	            $name123 = $result["dent_name"];
                $lastname123 = $result["dent_lastname"];   
                $address123 = $result["dent_address"];
	            $tel123 = $result["dent_tel"];
                $age123 = $result["dent_age"]; 
                $email123 = $result["dent_email"];       
                }
              ?>    
                              <form role="form">
                                    <div class="box-body">
