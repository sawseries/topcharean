        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <th><center>ชื่อประเภทการรักษา<center></th>
                                <th><center>รายละเอียดประเภทการรักษา<center></th>   
                                <th width="150" colspan="2" ><center><a
                                href="insert_treatment_type.php"><button type="button" class="btn btn-primary">เพิ่มข้อมูล</button></a></center></th>
                                </tr>           
                                </thead>
                                <?php
              	include "../../../server.php";
            ...
            ?>       
                <tr>
                                ...
                                <td><?php echo $result["treat_detail"];?></td>
            <td align="center"><a href="edit_treatment_type.php?user11=<?php echo $result["treat_id"];?>"><button type="button" class="btn btn-warning">แก้ไข</button></a></td>
            <td align="center"><a href="delete_treatment_type.php?user11=<?php echo $result["treat_id"];?>" 
