    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
              ...
              <form action="insert_treatment_type2.php" name="frmAdd" method="post"> 
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="txtTreatId" placeholder=รหัสประเภทการรักษา>
                                        </div>
                                        <div class="form-group">
                                            <label for="treat_name">ชื่อประเภทการรักษา</label>
                                            <input type="text" class="form-control" name="txtTreatName" placeholder=ชื่อประเภทการรักษา >
                                        </div>
                                        <div class="form-group">
                                            <label for="treat_detail">รายละเอียดประเภทการรักษา</label>
                                            <input type="text" class="form-control" name="txtTreatDetail" placeholder=รายละเอียดประเภทการรักษา >
                                        </div>
