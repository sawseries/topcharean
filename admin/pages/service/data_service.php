            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ข้อมูลการตรวจรักษา</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-body table-responsive">
                                    ...
                                    <thead>
                                    <tr>
                                <th><center>วันที่ตรวจรักษา<center></th>
                                <th><center>ประเภทการตรวจรักษา<center></th>
                                <th><center>รายละเอียดการตรวจรักษา<center></th>
                                <th width="150" colspan="3" ><center><a
                                <td align="center"><a href="insertform_service.php?user11=<?php echo $abc;?>"><button type="button" 
                                class="btn btn-primary">กรอกแบบฟอร์มการรักษา</button></a></td>
                                </tr>           
                                </thead>

            <?php
              	include "../../../server.php";
          	    $sql = "SELECT * FROM service,treatment_type where treatment_type.treat_id=service.treat_id && user_name = '$abc' ";
   	            $query = mysqli_query($objCon,$sql);
                while($result=mysqli_fetch_array($query,MYSQLI_ASSOC))
            {
            ?>       
                <tr>
                                <td><?php echo $result["serv_date"];?></td>
                                <td><?php echo $result["treat_name"];?></td>
                                <td><?php echo $result["serv_detail"];?></td>              
            <td align="center"><a href="data_service.php?user11="><button type="button" 
            class="btn btn-success">ตรวจสอบ</button></a></td>
            <td align="center"><a href="#?user11=<?php echo $result["user_name"];?>" 
