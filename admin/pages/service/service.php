        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <th><center>ผู้ป่วย<center></th>
                                <th><center>วันที่นัดหมาย<center></th>
                                <th><center>เวลานัดหมาย</th>
                                ...
                                <?php
              	include "../../../server.php";
          	    $sql = "SELECT * FROM appointment,members,medical_information where members.user_name=appointment.user_name && members.user_name=medical_information.user_name  && status_id = '2'
                         && app_date >= now()  order by  app_date ASC ";
                $i = 1;
            ...
            ?>       
                <tr>
                                ...
                                <td><?php echo $result["add_detail"];?></td>
            
            <td align="center"><a href="check_servm.php?user11=<?php echo $result["user_name"];?>"><button type="button" 
            class="btn btn-info">ประวัติการรักษา</button></a></td>
            <td align="center"><a href="insertform_service.php?user11=<?php echo $result["user_name"];?>&&app=<?= $result["app_id"];?>&&m=<?= $result["m_id"];?>"><button type="button" 
            class="btn btn-warning">กรอกข้อมูลการรักษา</button></a></td>
