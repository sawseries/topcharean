        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <h1>
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i></a></li>ตรวจสอบข้อมูลผู้ป่วย
                        <li class="active">ประวัติการรักษา</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <th><center>รายละเอียดการรักษา</th>
                                <th><center>ข้อมูลผู้ป่วย<center></th>         
                                </thead>


            <?php
                include "../../../server.php";
                $sql = "SELECT * FROM service where user_name = '$abc' ";
                $i = 1;
            ...
            <tr>
                                ...
                                <td><center><?php echo $result["serv_date"];?>
                                <td><?php echo $result["serv_detail"];?></td>
            <td align="center"><a href="check_servm2.php?user11=<?php echo $result["user_name"];?>&&serv=<?= $result["serv_id"];?>"><button type="button" 
