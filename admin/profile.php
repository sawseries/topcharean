...
?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i>ข้อมูลส่วนตัว</a></li>
                    </ol>
                </section>
                </section>
                            <!-- split buttons box -->
              ...
              <form action="editprofile.php" name="frmAdd" method="post"> 
                              ...
                              <form role="form">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3 ">
                                            ...
                                            <input type="text" class="form-control" name="user" value="<?php echo $user123;?>" readonly="1">
                                        </div>
                                        <div class="form-group col-md-3 ">
                                            <label for="pass">Password</label>
                                            <input type="text" class="form-control" name="pass" value="<?php echo $pass123;?>" >
                                        </div>
                                        <div class="form-group col-md-5">
                                            <label for="name">ชื่อ - สกุล</label>
                                            <input type="text" class="form-control" name="name" value="<?php echo $name123;?>" >
                                        </div>
